 ...
 *
 * Asl rasm JPEG holida qoladi (tashqi ulashish/og:image/yuklab olish kabi
 * joylarda eng keng qo'llab-quvvatlanadigan format bo'lgani uchun), lekin
 * lenta/profil kartalarida ko'rinadigan KICHIK nusxa endi WebP formatida
 * saqlanadi — xuddi shu ko'rinishda ~25-35% kichikroq fayl hajmi, demak
 * tezroq yuklanish va kamroq trafik (ayniqsa sekin internetda muhim).
 */
async function compressAndThumbnail(absPath) {
  ...
  // Lenta/kolleja uchun kichik nusxa (WebP — xuddi shu sifatda ancha yengil)
  await sharp(buf)
